...
import com.recharge.base.config.ConfigKey;
...
//			}
	...
	private final static void initDataPool() {
		...
		config.setJdbcUrl(String.format(dbUrl, Config.getConfig(ConfigKey.MYSQL_CONF, ConfigKey.HOST), Config.getConfig(ConfigKey.MYSQL_CONF, ConfigKey.PORT), Config.getConfig(ConfigKey.MYSQL_CONF, ConfigKey.DB_DATA)));
	...
	private final static void initLogPool() {
		HikariConfig config = new HikariConfig();
		config.setJdbcUrl(String.format(dbUrl, Config.getConfig(ConfigKey.MYSQL_CONF, ConfigKey.HOST), Config.getConfig(ConfigKey.MYSQL_CONF, ConfigKey.PORT), Config.getConfig(ConfigKey.MYSQL_CONF, ConfigKey.DB_LOG)));
		config.setUsername(Config.getConfig(ConfigKey.MYSQL_CONF, ConfigKey.USER));
		config.setPassword(Config.getConfig(ConfigKey.MYSQL_CONF, ConfigKey.PASS));
		// 获取连接超时ms
		config.setConnectionTimeout(5000);
