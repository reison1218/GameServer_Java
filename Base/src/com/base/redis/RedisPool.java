...
//			shardedJedis = shardedJedisPool.getResource();
	...
	public static Long zrevrank(String key, String userId) {
		Jedis jedis = jedisPool.getResource();
		Long rank = null;

		try {
			rank = jedis.zrevrank(key, userId);
		} catch (Exception e) {
			e.printStackTrace();
		} finally {
			recyleClient(jedis);
	...
	public static Double zscore(String key, String userId) {
		Double score = null;
		Jedis jedis = jedisPool.getResource();

		try {
			score = jedis.zscore(key, userId);
		} catch (Exception e) {
			e.printStackTrace();
		} finally {
			recyleClient(jedis);
	...
	public static String hget(String key, String userId) {
		Jedis jedis = jedisPool.getResource();
		String tId = null;
		try {
			tId = jedis.hget(key, userId);
		} catch (Exception e) {
			e.printStackTrace();
		} finally {
			recyleClient(jedis);
	...
	public static void hset(String key, String userId, String value) {
		Jedis jedis = jedisPool.getResource();
		try {
			jedis.hset(key, userId, value);
		} catch (Exception e) {
			e.printStackTrace();
	...
	public static void hdel(String key, String userId) {
		Jedis jedis = jedisPool.getResource();
		try {
			jedis.hdel(key, userId);
		} catch (Exception e) {
			e.printStackTrace();
		} finally {
			recyleClient(jedis);
