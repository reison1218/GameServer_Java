package com.base.netty.wsserver;
 ...
 *
 */
public class WebSocketServer extends BaseNettyServer {

	public WebSocketServer(int port, int workThreadCount, ChannelInitializer<SocketChannel> serverInitializer) {
	...
	protected void initParam(ServerBootstrap b) {
		...
		// 接收区缓存大小(32K=短整型最大值)
		b.childOption(ChannelOption.SO_RCVBUF, 8 * 1024);
		// 发送区缓存大小(32K)
		...
		b.childOption(ChannelOption.WRITE_BUFFER_WATER_MARK, new WriteBufferWaterMark(1024 * 1024, 1024 * 2048));
	}
