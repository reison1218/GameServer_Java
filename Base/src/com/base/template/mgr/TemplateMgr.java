...
import com.base.config.SystemEnv;
...
public abstract class TemplateMgr {
	...
	public static boolean init() {
		...
		// template路径
		String filePath = "/Users/tangjian/Desktop/work/javaserver/gameserver/Deploy/template";
		...
		try {
			...
			for (File _file : file.listFiles()) {
				...
				Class<?> clazz = Class.forName("com.base.template." + name);
