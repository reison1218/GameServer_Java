...
import game.base.threadpool.ThreadPool;
...
public final class ExecutorMgr {
    ...
    private final static ThreadPool threadPool = new ThreadPool("Http-Server", 8);
    ...
    public static ThreadPool getUserSyncThreadPool() {
        return threadPool;
    }
}
