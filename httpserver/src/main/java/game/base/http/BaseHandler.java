...
public abstract class BaseHandler extends AbstractHandler {
     ...
     * 发送错误状态
     */
    public void sendErrorResponse(Request baseRequest, HttpServletResponse response, int code,JSONObject json) throws IOException {
        response.setStatus(code);
        response.getOutputStream().write(json.toJSONString().trim().getBytes());
        baseRequest.setHandled(true);
    }
