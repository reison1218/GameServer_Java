...
public class TimeUtil {
	 ...
	 * @return yyyyMMddHHmmss
	 */
	public static String getNumDateFormat(java.util.Date date) {
	 ...
	 * @return yyyyMMdd
	 */
	public static String getNumDateOnlyFormat(java.util.Date date) {
	 ...
	 * @return
	 */
	public static String getDateOnlyFormat(java.util.Date date) {
	...
	public static Date getDefaultDate() {
		...
		try {
			defaultDate = (java.util.Date) formatter.parse(TIME_2000);
	...
	public final static Date getDefaultMaxDate() {
		java.util.Date defaultDate = null;
		try {
			defaultDate = (java.util.Date) formatter.parse(TIME_2999);
		} catch (ParseException e) {
			e.printStackTrace();
		}
		return new Date(defaultDate.getTime());
	...
	public final static Date get2038Date() {
		java.util.Date defaultDate = null;
		try {
			defaultDate = (java.util.Date) formatter.parse(TIME_2038);
		} catch (ParseException e) {
			e.printStackTrace();
		}
		return new Date(defaultDate.getTime());
